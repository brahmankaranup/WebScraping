...
Columns = ['Name', 'Designation', 'Company', 'Location', 'Connections', 'Followers', 'About', 'Experience', 'Education',
           'Endorsements']
...
for i in range(50):
    ...
    Abt = soup.find('section',{'class': "pv-profile-section pv-about-section artdeco-card p5 mt4 ember-view"})
    ...
    if type(exp_section) != type(None):
        ...
        for exp in exp_section:
            ...
            company_duration = exp.find('h4',{'class':"t-14 t-black--light t-normal"})
            if type(company_duration) != type(None):
                exp_durations_list.append(company_duration.get_text().strip())
            else:
                exp_durations_list.append("")
    ...
    Append_List = [Name, Designation, Company, Location, No_of_Connections, No_of_Followers, About_Desc, Experience, Education, Endorsements]
...
result_file_path = "C:/Users/one/Documents/new1/res/demo.csv"
