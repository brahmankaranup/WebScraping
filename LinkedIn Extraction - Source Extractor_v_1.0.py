...
df = pd.read_csv("C:/Users/brahm/Desktop/Web Scraping/linkedIn_Connections_Data.csv")
...
while(i < 50):
	...
	file_name = name+'.txt'
	file_path = "C:/Users/brahm/Desktop/Web Scraping/Scraping/New folder/"+file_name
