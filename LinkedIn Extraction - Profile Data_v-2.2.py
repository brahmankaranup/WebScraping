...
df = pd.read_csv(r"C:\Users\brahm\Desktop\Web Scraping\Divided Dataset\SUSHRUT_test_set.csv",encoding = 'latin-1')
...
for i in range(51) :
	...
	file_path = "C:/Users/brahm/Desktop/Web Scraping/Scraping/New folder (4)/output/"+file_name
	...
	#getting interests
	interests = soup.find('section',{'class': "pv-profile-section pv-interests-section artdeco-card mt4 p5 ember-view"})
	if type(interests) != type(None) :
...
result_file_path = "C:/Users/brahm/Desktop/Web Scraping/Results/Linkedin_Data_0.4.csv"
